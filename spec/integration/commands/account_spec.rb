...
describe "Account list" do
  ...
  context "account:list with account name" do
    it "should report success" do
      ...
      rsp.stdout.should include("  compute_availability_zone: \n")
      rsp.stdout.should include("  storage_availability_zone: \n")
      rsp.stdout.should include("  cdn_availability_zone: \n")
      rsp.stdout.should include("  block_availability_zone: \n")
