...
describe "Config command" do
  ...
  context "set everything" do
    it "should set value" do
      rsp = cptr("config:update default_auth_uri=1 block_availability_zone=2 storage_availability_zone=3 compute_availability_zone=4 connect_timeout=6 read_timeout=7 write_timeout=8 ssl_verify_peer=9 ssl_ca_path=10 ssl_ca_file=11")
      rsp.stderr.should eql("")
      rsp.stdout.should eql("Configuration set default_auth_uri=1 block_availability_zone=2 storage_availability_zone=3 compute_availability_zone=4 connect_timeout=6 read_timeout=7 write_timeout=8 ssl_verify_peer=9 ssl_ca_path=10 ssl_ca_file=11\n")
      rsp.exit_status.should be_exit(:success)
