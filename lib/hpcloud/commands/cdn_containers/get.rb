module HP
  module Cloud
    class CLI < Thor
      ...
      long_desc <<-DESC
  Get the value of an attribute for an existing CDN container. The allowed attributes whose value can be retrieved are 'X-Ttl', 'X-Cdn-Uri', 'X-Cdn-Enabled', 'X-Log-Retention'. Optionally, an availability zone can be passed.
