...
Examples:
  ...
  hpcloud servers:add my_server small -v  -k key1 -m this=that     # Create a new small server named 'my_server' using the specified image, flavor, key and metadata this=that:
