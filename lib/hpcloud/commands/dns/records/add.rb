...
Examples:
  hpcloud dns:records:add mydomain.com. www.mydomain.com A 10.0.0.1 # Create a DNS record for the 'mydomain.com.' domain an 'A' record for 'www.mydomain.com' pointing to 10.0.0.1:
      DESC
