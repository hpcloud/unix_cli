...
- HP Cloud Ruby Fog Binding[http://build.hpcloud.com/bindings/fog]

2) Download the HP Cloud Services Unix CLI gem[http://build.hpcloud.com/cli/unix] and unpack it into a local directory.
...
Detailed documentation and usage examples can be found at HP Cloud Unix CLI[http://build.hpcloud.com/cli/unix] page.
