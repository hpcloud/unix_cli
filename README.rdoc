...
- HP Cloud Ruby Fog Binding[http://manage.hpcloud.com/pages/build/bindings/fog]

2) Download the HP Cloud Services Unix CLI gem[http://manage.hpcloud.com/downloads/hpcloudcli.tar] and unpack it into a local directory.
